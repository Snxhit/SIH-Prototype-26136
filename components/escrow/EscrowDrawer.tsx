    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm">
      ...
      <aside className="fixed right-0 top-0 z-10 flex h-full w-[26rem] max-w-full animate-in flex-col border-l border-border bg-background shadow-2xl slide-in-from-right duration-300">
        <header className="flex items-center justify-between border-b border-border p-5">
          <div>
            <h3 className="flex items-center gap-2 text-sm font-bold">
              <Landmark className="size-4 text-[#818cf8]" /> Smart Escrow Vault
            </h3>
        ...
        <div className="border-b border-border p-5">
          ...
          <p className="mt-1 font-mono text-3xl font-black tracking-tight text-[#818cf8]">
...
<p className="mt-0.5 font-mono font-bold text-[#818cf8]">
